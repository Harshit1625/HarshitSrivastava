...
const Header: FC = () => {
  return (
    <div>
      <ul className="flex justify-between p-2 font-bold cursor-pointer">
        <li>
          <img
            className="lg:h-[8vh] sm:w-[12vw] lg:w-[12vw] h-[12vh] w-[30vw] object-cover"
            src="/Project image .png"
            alt="signature"
          />
        </li>
        <li className="hover:opacity-100 hidden sm:block md:block lg:block opacity-70 transition ease-in-out">
          <p className="flex lg:mt-5 mt-[5vh]">
            <span>
              <svg
                viewBox="0 -2.5 20 20"
                version="1.1"
            ...
            <h1> harshitsri1625@gmail.com </h1>
          </p>
        </li>
        <li className="hover:opacity-100 opacity-70 transition ease-in-out">
          <p className="flex lg:mt-5 mt-[5vh]">
            ...
            <h1 className="lg:tracking-widest md:tracking-widest"> +91-6390710296 </h1>
          </p>
        </li>
      </ul>
    </div>
